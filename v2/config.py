...
# ============================================================================
VAD_ON_THRESHOLD = 0.2       # EMA probability to trigger speech
VAD_OFF_THRESHOLD = 0.15      # EMA probability to end speech
VAD_EMA_ALPHA = 0.1           # EMA smoothing factor (0-1, higher = more responsive)
