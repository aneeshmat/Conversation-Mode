...
class DuckController:
    ...
    def notify_speech(self):
        ...
        # If not ducked, or user changed volume, re-duck
        if not self.ducked or (self.target is not None and abs(base - self.target) > VOLUME_RESTORE_TOL):
...
def processing_worker():
    ...
    while running_worker:
        ...
        # Use EC (voice-engine/ec) for echo cancellation
        ...
        # Ducking is sustained as long as speech is detected
